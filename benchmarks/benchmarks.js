  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function applyGateUI() {
      ...
      if (!document.getElementById('bm-steps')) {
        ...
        var _sub = document.getElementById('bm-sub');
        if (_sub && _sub.parentNode) _sub.parentNode.insertBefore(stepsEl, _sub.nextSibling);
      }
