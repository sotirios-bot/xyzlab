(function () {
  ...
  var countries = {
    ...
    'Austria':  { trafficm: 0.12, ctrm: 0.93, compm: 0.78 },
    'Bahrain':      { trafficm: 0.04, ctrm: 0.85, compm: 0.68 },
    'Bangladesh':  { trafficm: 0.5, ctrm: 0.82, compm: 0.45 },
    'Belgium':  { trafficm: 0.14, ctrm: 0.94, compm: 0.8 },
    'Brazil':       { trafficm: 0.72, ctrm: 0.88, compm: 0.72 },
    'Bulgaria':  { trafficm: 0.1, ctrm: 0.86, compm: 0.62 },
    'Canada':       { trafficm: 0.42, ctrm: 1.05, compm: 0.88 },
    'Chile':  { trafficm: 0.12, ctrm: 0.88, compm: 0.68 },
    'Colombia':  { trafficm: 0.22, ctrm: 0.88, compm: 0.68 },
    'Croatia':  { trafficm: 0.05, ctrm: 0.88, compm: 0.65 },
    'Czechia':  { trafficm: 0.14, ctrm: 0.9, compm: 0.78 },
    'Denmark':      { trafficm: 0.10, ctrm: 1.02, compm: 0.78 },
    'Ecuador':  { trafficm: 0.14, ctrm: 0.86, compm: 0.58 },
    'Egypt':  { trafficm: 0.35, ctrm: 0.88, compm: 0.6 },
    'Finland':  { trafficm: 0.08, ctrm: 0.95, compm: 0.82 },
    'France':       { trafficm: 0.48, ctrm: 0.92, compm: 0.82 },
    'Germany':      { trafficm: 0.55, ctrm: 0.95, compm: 0.88 },
    'Greece':  { trafficm: 0.16, ctrm: 0.92, compm: 0.7 },
    'Hong Kong':    { trafficm: 0.10, ctrm: 0.92, compm: 0.78 },
    'Hungary':  { trafficm: 0.15, ctrm: 0.9, compm: 0.68 },
    ...
    'Taiwan':  { trafficm: 0.28, ctrm: 0.87, compm: 0.8 },
    ...
    'Ukraine':  { trafficm: 0.3, ctrm: 0.88, compm: 0.62 },
    'Uruguay':  { trafficm: 0.08, ctrm: 0.88, compm: 0.6 },
    'Venezuela':  { trafficm: 0.16, ctrm: 0.84, compm: 0.52 },
